...
public abstract class MapUtils {
    ...
    Map<K, V> buildUnmodifiableMap(Function<V, K> keyGetter, V firstElem, V... remainingElems) {
        return buildUnmodifiableMap(keyGetter, new LinkedHashMap<>(remainingElems.length + 1), firstElem, remainingElems);
    }
    ...
    @SafeVarargs
    public static <K extends Comparable<? super K>, V>
    Map<K, V> buildUnmodifiableMap(Function<V, K> keyGetter, Map<K, V> map, V firstElem, V... remainingElems) {
